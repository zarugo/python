      ...
      function _factory() {
        ...
        this.getMenuItems = function() {
          ...
          var menuItems = states.filter(function(item) {
            //return ((item.level == 0) && (item.roles.indexOf($rootScope.currOperator.role) !== -1));
			var hasPermission = item.roles.indexOf($rootScope.currOperator.role);
			return ((item.level == 0) && (hasPermission >= 0));
          });
