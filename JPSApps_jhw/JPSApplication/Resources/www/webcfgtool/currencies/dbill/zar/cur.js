$(document).ready(function() {
	$("#dbill-zar").alpaca({
		"dataSource": "./dbill/zar/cur.json",
		"schemaSource": "./dbill/ConfigSchema.json",
		"view":"bootstrap-edit-horizontal",
		"optionsSource": "./dbill/ConfigOptions.json",
		///////////////////////////////////////////////////////////////////////////// OPTIONS /////////////////////////////////////////////////////////////////
		"options": {
			"form":{
				"attributes":{
					...
					"submit0":{
						...
						"click": function() {
							...
							if (this.isValid(true)) {
								...
								request.open("POST", "/webcfgtool/currencies/dbill/zar");
