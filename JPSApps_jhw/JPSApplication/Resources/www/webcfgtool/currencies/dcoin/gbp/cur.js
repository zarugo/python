$(document).ready(function() {
	$("#dcoin-gbp").alpaca({
		"dataSource": "./dcoin/gbp/cur.json",
		"schemaSource": "./dcoin/ConfigSchema.json",
		"view":"bootstrap-edit-horizontal",
		"optionsSource": "./dcoin/ConfigOptions.json",
		///////////////////////////////////////////////////////////////////////////// OPTIONS /////////////////////////////////////////////////////////////////
		"options": {
			"form":{
				"attributes":{
					...
					"submit0":{
						...
						"click": function() {
							...
							if (this.isValid(true)) {
								...
								request.open("POST", "/webcfgtool/currencies/dcoin/gbp");
