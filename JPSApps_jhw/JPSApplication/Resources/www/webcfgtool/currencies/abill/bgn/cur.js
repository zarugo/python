$(document).ready(function() {
	$("#abill-bgn").alpaca({
		"dataSource": "./abill/bgn/cur.json",
		"schemaSource": "./abill/ConfigSchema.json",
		"view":"bootstrap-edit-horizontal",
		"optionsSource": "./abill/ConfigOptions.json",
		///////////////////////////////////////////////////////////////////////////// OPTIONS /////////////////////////////////////////////////////////////////
		"options": {
			"form":{
				"attributes":{
					...
					"submit0":{
						...
						"click": function() {
							...
							if (this.isValid(true)) {
								...
								request.open("POST", "/webcfgtool/currencies/abill/bgn");
