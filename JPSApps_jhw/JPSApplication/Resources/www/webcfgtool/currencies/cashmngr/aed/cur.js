$(document).ready(function() {
	$("#cashmngr-aed").alpaca({
		"dataSource": "./cashmngr/aed/cur.json",
		"schemaSource": "./cashmngr/ConfigSchema.json",
		"view":"bootstrap-edit-horizontal",
		"optionsSource": "./cashmngr/ConfigOptions.json",
		///////////////////////////////////////////////////////////////////////////// OPTIONS /////////////////////////////////////////////////////////////////
		"options": {
			"form":{
				"attributes":{
					...
					"submit0":{
						...
						"click": function() {
							...
							if (this.isValid(true)) {
								...
								request.open("POST", "/webcfgtool/currencies/cashmngr/aed");
